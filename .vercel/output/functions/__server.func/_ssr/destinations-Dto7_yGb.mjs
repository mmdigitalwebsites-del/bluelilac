...
import { m as maasaiMara, n as nakuru, t as tourSerengeti, o as olpejeta, d as tourBunyonyi, e as tourBeach, f as nairobi, g as tourUganda } from "./router-Dfz_60ae.mjs";
...
function Hero({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex h-[72vh] min-h-[540px] w-full items-center overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: tourUganda, alt: "", className: "absolute inset-0 h-full w-full object-cover" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto w-full max-w-7xl px-6 md:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mb-6 mt-32 inline-flex w-fit items-center rounded-full border border-white/30 bg-white/10 px-5 py-2 text-sm text-white backdrop-blur-md", children: "Kenya · Tanzania · Uganda · Rwanda · Zanzibar" }),
