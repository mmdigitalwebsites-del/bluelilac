...
//       {/* Hero */}
//       <section className="relative flex h-[65vh] min-h-[460px] w-full items-end overflow-hidden">
//         <img
//           src={tour.img}
//           alt={tour.title}
//           className="absolute inset-0 h-full w-full object-cover"
...
//             <ArrowLeft className="h-4 w-4" /> All tours
//           </Link>
//           <span className="mt-6 ml-16 inline-flex w-fit items-center rounded-full border border-white/30 bg-white/10 px-4 py-1.5 text-xs uppercase tracking-[0.2em] text-white backdrop-blur-md">
//             {tour.destination}
//           </span>
