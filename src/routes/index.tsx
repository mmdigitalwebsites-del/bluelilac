...
import tourUganda from "@/assets/gorrila.webp";
...
function Testimonials() {
  ...
  // "Recognised by" logo strip. GOOGLE_REVIEWS itself now lives in
  // src/data/reviews.ts so both this page and About share one source.
  const marqueeGoogleReviews = [...GOOGLE_REVIEWS, ...GOOGLE_REVIEWS];
