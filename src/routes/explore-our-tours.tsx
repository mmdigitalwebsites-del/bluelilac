  ...
  head: () => ({
    meta: [
      { title: "Explore Our Tours — Bluelilac Tours" },
      {
        name: "description",
        content:
          "Discover handcrafted East African safari experiences — from the Great Migration to gorilla trekking and Zanzibar beach escapes.",
      },
      ...
      <section className="relative flex h-[70vh] min-h-[520px] w-full items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 md:px-10">
          ...
          <p className="mt-6 max-w-xl text-base text-white/85 md:text-lg">
            Bush, beach, gorillas and the Great Migration — find the East African experience that
            calls you.
          </p>
      ...
      <section className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center md:px-10">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-white/85">
            Tell us your dates and dream destinations — we'll craft a bespoke itinerary just for
            you.
          </p>
