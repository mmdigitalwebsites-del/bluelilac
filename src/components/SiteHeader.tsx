  ...
  return (
    <header className="absolute top-8 left-0 right-0 z-30">
      <div className="mx-auto max-w-7xl px-4 pt-4 md:px-6">
        <div
          className={`flex h-[60px] items-center justify-between gap-4 rounded-full border backdrop-blur-xl shadow-lg px-4 py-1 md:px-6 transition-colors duration-300 ${
